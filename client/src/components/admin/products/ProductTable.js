                        ...
                        products.map((item, key) => (
                            <tr key={key} className="group hover:bg-gray-50/30 transition-all">
                                ...
                                <td className="px-6 py-4">
                                    <div className="w-14 h-14 rounded-xl overflow-hidden bg-gray-100 border border-gray-100 shadow-sm shrink-0">
                                        <img 
                                ...
                                {/* Description */}
                                <td className="px-6 py-4">
                                    <p className="text-[10px] text-gray-800 font-bold tracking-tight lowercase line-clamp-1 max-w-[150px]">
                                        {item.pDescription}
                                    </p>
                                </td>
                                ...
                                {/* Created At */}
                                <td className="px-6 py-4">
                                    <span className="text-[9px] text-gray-800 font-mono font-bold uppercase whitespace-nowrap">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end space-x-1">
                                        <button
                                            ...
                                            className="w-6 h-6 flex items-center justify-center rounded-lg bg-gray-50 text-gray-600 hover:bg-gray-900 hover:text-white transition-all transform active:scale-90"
                                            title="Edit"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="w-6 h-6 flex items-center justify-center rounded-lg bg-gray-50 text-gray-600 hover:bg-rose-500 hover:text-white transition-all transform active:scale-90"
                                            title="Delete"
                                        >
