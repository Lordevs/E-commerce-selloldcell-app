                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <input
                            ...
                            value={fData.pOffer}
                            placeholder="0"
                            className="px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-500 transition-all font-medium text-xs text-gray-600 uppercase tracking-tight text-rose-500"
                            type="number"
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="flex flex-col space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-600 group-hover:text-emerald-600 transition-colors">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        {fData.pSize === "Other" && (
                            <input
                                ...
                                type="number"
                                className="mt-3 px-4 py-3 bg-gray-50 border-2 border-emerald-400 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-600 transition-all font-medium text-xs text-gray-600 uppercase tracking-tight"
                                required
                            />
                        )}
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-8 flex flex-col space-y-2">
                        ...
                        <textarea
                            ...
                            className="px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-500 transition-all font-medium text-xs text-gray-500 min-h-[120px] italic"
                            required
                        />
                    </div>
                    <div className="lg:col-span-4 flex flex-col space-y-2">
                        ...
                        <input
                            ...
                            placeholder="0"
                            className="px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:bg-white focus:border-emerald-500 transition-all font-medium text-xs text-gray-600 text-center tracking-tighter"
                            type="number"
                            required
                        />
                    </div>
